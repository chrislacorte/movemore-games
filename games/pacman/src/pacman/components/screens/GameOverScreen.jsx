...
export default function GameOverScreen({ score, level, reason, onRetry }) {
  const sub =
    reason === 'hand_lost'
      ? STRINGS.gameOverHand
      : reason === 'ghost'
        ? STRINGS.gameOverGhost
        : STRINGS.gameOverGhost
